...
void DeviceCaps::LogCaps()
{
	...
	LogInfo(LogVulkan) << format(formatStr2, "framebufferColorSampleCounts:", VkTypeToString(limits.framebufferColorSampleCounts)) << endl;
	LogInfo(LogVulkan) << format(formatStr2, "framebufferDepthSampleCounts:", VkTypeToString(limits.framebufferDepthSampleCounts)) << endl;
	LogInfo(LogVulkan) << format(formatStr2, "framebufferStencilSampleCounts:", VkTypeToString(limits.framebufferStencilSampleCounts)) << endl;
	LogInfo(LogVulkan) << format(formatStr2, "framebufferNoAttachmentsSampleCounts:", VkTypeToString(limits.framebufferNoAttachmentsSampleCounts)) << endl;
	LogInfo(LogVulkan) << format(formatStr2, "maxColorAttachments:", limits.maxColorAttachments) << endl;
	LogInfo(LogVulkan) << format(formatStr2, "sampledImageColorSampleCounts:", VkTypeToString(limits.sampledImageColorSampleCounts)) << endl;
	LogInfo(LogVulkan) << format(formatStr2, "sampledImageIntegerSampleCounts:", VkTypeToString(limits.sampledImageIntegerSampleCounts)) << endl;
	LogInfo(LogVulkan) << format(formatStr2, "sampledImageDepthSampleCounts:", VkTypeToString(limits.sampledImageDepthSampleCounts)) << endl;
	LogInfo(LogVulkan) << format(formatStr2, "sampledImageStencilSampleCounts:", VkTypeToString(limits.sampledImageStencilSampleCounts)) << endl;
	LogInfo(LogVulkan) << format(formatStr2, "storageImageSampleCounts:", VkTypeToString(limits.storageImageSampleCounts)) << endl;
